...
public class MNISTReader {
    ...
    public ArrayList<DigitImage> loadDigitImages(String labelFileName, String imageFileName) throws IOException {
        ArrayList<DigitImage> images = new ArrayList<DigitImage>();

        ByteArrayOutputStream labelBuffer = new ByteArrayOutputStream();
        ByteArrayOutputStream imageBuffer = new ByteArrayOutputStream();

        GZIPInputStream labelInputStream = new GZIPInputStream(new FileInputStream(labelFileName));
        GZIPInputStream imageInputStream = new GZIPInputStream(new FileInputStream(imageFileName));
        ...
        int magic = ByteBuffer.wrap(imageMagic).getInt();
